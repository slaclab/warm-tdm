...
| `verify_frame_header.py` | #82 | End-to-end frame identity and decoding (hardware or cosim) | Loaded image/fixture provenance |
| `reproduce_readall_lockup.py` | Register-timeout investigation | Targeted SRP/ReadAll reproducer (hardware or cosim) | Physical transport interpretation |
