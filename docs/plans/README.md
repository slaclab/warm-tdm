...
| Register timeouts and RSSI/SRP hardware investigation | [Register timeout](register-timeout/README.md); [hardware agent instructions and scripts](register-timeout/hardware-handoff/README.md) | Unresolved hardware regression; preserve the exact source/image comparison |
