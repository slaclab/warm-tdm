...
class SaBiasOffsetAwaXe(pr.Device):
    def __init__(self, awaXe, saBiasDac, saOffsetDac, frontEnd, **kwargs):
        super().__init__(**kwargs)

        self.shunt = 15.0e3

        self._awaXe = awaXe
        self._awaXeBias = [awaXe.Ch0Dac300A, awaXe.Ch1Dac300A]
