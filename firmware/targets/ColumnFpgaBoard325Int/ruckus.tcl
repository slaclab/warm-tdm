...
##############################################################################
# Non-coordinator ColumnFpgaBoard, integer (AdcDsp) PID datapath
# (USE_FLOAT_PID_G=false). RING_ADDR_0_G=false, so PgpEthCore gates the Ethernet
...
set_property generic "[get_property generic [current_fileset]] RING_ADDR_0_G=false ETH_10G_G=false GEN_ADC_FILTER_G=false GEN_PID_DEBUG_G=false RSSI_WINDOW_ADDR_SIZE_G=2 ROW_ADDR_BITS_G=6 USE_FLOAT_PID_G=false" [current_fileset]
